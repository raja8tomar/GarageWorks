 ...
 <%
       ...
       if(m !=null){
    	   ...
    	   "Photo Not Uploaded"
    		   ...
    		   <% 
    	   }else if(m.equalsIgnoreCase("mismatch")){
    		  %>
    		   <div class="alert alert-danger">
    	   " New Passwords Not Match"
    	   </div>
    		  <%
    	   }else if(m.equalsIgnoreCase("wrong")){
     		  %>
   		   <div class="alert alert-danger">
   	   " Old Passwords Worng"
   	   </div>
   		  <%}else if(m.equalsIgnoreCase("changed")){
    		  %>
   		   <div class="alert alert-success">
   	   " Password Changed"
   	   </div>
    ...
    <nav class="navbar navbar-expand-sm bg-light sticky-top px-4">
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavbar">
            ...
            <div>
               Welcome:<a href="userHome.jsp"><b><%=userDetails.get("name") %></b></a>
   ...
   <div class="row">
    <div class="col-sm p-3 my-4 border">
      <h3> Photo Upload</h3>
      <hr/>
       <form action="uploadUserPhoto" method="post" enctype="multipart/form-data">
           
          
            <div class="py-2">
                <input name="Photo" class="form-control" type="file"  accept=".png,.jpf" />
            </div>
            <div class="py-2">
      ...
      <hr/>
       <form action=changeUserPassword  method="post">
            ...
            <div class="py-2">
                <input name="o_password" class="form-control" type="password" placeholder="Old Password"  required />
            </div>
             <div class="py-2">
                <input name="n_password" class="form-control" type="password" placeholder="New Password"  required />
            </div>
             <div class="py-2">
    ...
    <footer>
            Design & Develop by <a href="https://www.incapp.in">RAJAT TOMAR</a> &copy; Reights reserved &nbsp;&nbsp;&nbsp; 
            Social Media:
