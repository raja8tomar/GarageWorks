...
<body>
   ...
   <section class=" p-2" >
     ...
     if(status.equalsIgnoreCase("Pending")){
        ...
        String email=(String)garageOwnerDetails.get("email");
           ArrayList<HashMap> Servicesdetails=d.getServices(email);
           
           for(HashMap services:Servicesdetails){
        	   
              %>
        	   <div class="bg-light p-2 m-2">
        	   <p>
        	    <h5>ID:<b><%=services.get("id") %></b></h5>
        	     <h5>Service:<b><%=services.get("services") %></b></h5>
        	    
        	    <a class="btn btn-danger btn-sm" href="deleteServices?id=<%=services.get("id")%> " >DELETE</a>
        	  <p>
        	   </div>
