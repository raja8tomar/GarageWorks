...
<body>
   ...
   <section class="container" py-2>
        <% 
           ...
           ArrayList<HashMap> AllgarageOwnerdetails=d.getGarageStatus("pending");
           for(HashMap details:AllgarageOwnerdetails){
        	  ...
        	  Phone:<b><%= details.get("phone") %></b>
        	    ...
        	    <p>
        	   Status:<b><%= details.get("status") %></b>
        	  	   </p>
        	   <a class="btn btn-success btn-sm" href="changeGarageStatus?email=<%= details.get("email") %>&status=Accepted ">Accept</a>
        	   
        	   <a class="btn btn-danger btn-sm" href="changeGarageStatus?email=<%= details.get("email") %>&status=Rejected" >Reject</a>
        	   <a class="btn btn-dark btn-sm" href="adminGarageDetails.jsp?email=<%= details.get("email") %>" >Details</a>
