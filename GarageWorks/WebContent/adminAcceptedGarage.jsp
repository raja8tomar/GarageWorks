...
<body>
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavbar">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                 ...
                 <li class="nav-item">
                    <a class="nav-link" href="adminHome.jsp">Accepted</a>
                </li>
                 <li class="nav-item">
                    <a class="nav-link" href="adminHome.jsp">Pending</a>
                </li>
                 <li class="nav-item">
                    <a class="nav-link" href="adminHome.jsp">Rejected</a>
                </li>
   ...
   <section class="container" py-2>
        <% 
           ...
           ArrayList<HashMap> AllgarageOwnerdetails=d.getGarageStatus("Accepted");
           for(HashMap details:AllgarageOwnerdetails){
        	 ...
        	 Shop_No:<b><%= details.get("shop_no") %></b>
        	   ...
        	   <a class="btn btn-danger btn-sm" href="changeGarageStatus?email=<%= details.get("email") %>&status=Rejected">DEACTIVATE</a>
