...
<body>
   ...
   <section class="container" py-2>
        <% 
           ...
           ArrayList<HashMap> AllgarageOwnerdetails=d.getGarageStatus("Rejected");
           for(HashMap details:AllgarageOwnerdetails){
        	 ...
        	 Shop_No:<b><%= details.get("shop_no") %></b>
        	   ...
        	   <a class="btn btn-success btn-sm" href="changeGarageStatus?email=<%= details.get("email") %>&status=Accepted ">ACTIVATE</a>
